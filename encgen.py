...
#
# Usage:
# python encgen.py difficultyLevel CharLev1 ... CharLevN
# where difficultyLevel is one of "easy", "medium", "hard", or "deadly"
# CharLev's are the character levels separated by spaces
#
# Example usage:
# python encgen.py hard 9 9 9 9 9
# to generate hard encounters for a party of 5 level 9 characters
...
if rating == "help":
    print "encgen.py"
    print "generate D&D 5e encounter blocks based on dificulty and party level"
    ...
    print ""
    print "Usage:"
    print "python encgen.py difficultyLevel CharLev1 ... CharLevN"
    ...
    print ""
    print "Example usage:"
    print "python encgen.py hard 9 9 9 9 9"
    print "to generate hard encounters for a party of 5 level 9 characters"
    exit()

if len(sys.argv) < 3:
    print "needs a encounter difficulty and character levels"
    print "use python encgen.py help for help"
    exit()
...
if rating == "no":
    ratingmin = 0
    ratingmax = easythresh
elif rating == "easy":
    ratingmin = easythresh - 1
    ratingmax = medithresh
elif rating == "medium" or rating == "med":
    ratingmin = medithresh - 1
    ratingmax = hardthresh
elif rating == "hard":
    ratingmin = hardthresh - 1
    ratingmax = deadthresh
elif rating == "dead" or rating =="deadly":
    ratingmin = deadthresh - 1
    ratingmax = maxxp
else:
    print "fuck you"
    exit()
